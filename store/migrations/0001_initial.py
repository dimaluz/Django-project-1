# Generated by Django 3.2.9 on 2023-08-12 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999999.99'}}, help_text='Maximum 999999.99', max_digits=10, verbose_name='Regular price')),
                ('discount_price', models.DecimalField(decimal_places=2, error_messages={'name': {'max_length': 'The price must be between 0 and 999999.99'}}, help_text='Maximum 999999.99', max_digits=10, verbose_name='Discount price')),
                ('is_active', models.BooleanField(default=True, help_text='Change the product visibility', verbose_name='Product Visibility')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(help_text='Product specification value (maximun of 255 words)', max_length=255, verbose_name='value')),
