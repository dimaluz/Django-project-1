...
class Customer(AbstractBaseUser, PermissionsMixin):
	...
	def email_user(self, subject, message):
		send_mail(subject, message, 'dimaluz@rambler.ru', [self.email], fail_silently=False)
...
class Address(models.Model):
	...
	delivery_instructions = models.CharField(_("Delivery Instractions"), max_length=255)
